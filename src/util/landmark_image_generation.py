    ...
    def __init__(self, output_size):
        ...
        self.facial_part = [
            ...
            },
            {
                ...
                "mouth": [
                    [52, 54, 53, 62, 58, 59, 57, 65, 66, 71, 69, 68, 52],
                    [55, 56, 63, 61, 60, 64, 70, 67, 55],
                ],  # 20
    ...
    def generate_landmark_img(self, landmarks):
        ...
        for i in range(len(self.landmark_img_sizes)):
            ...
            self.draw_line(
                landmark_img,
                cur_landmarks,
                cur_facial_part["left_eyebrow"],
                self.facial_part_color["left_eyebrow"],
                line_width,
            )
            self.draw_line(
                landmark_img,
                cur_landmarks,
                cur_facial_part["right_eyebrow"],
                self.facial_part_color["right_eyebrow"],
                line_width,
            )
            self.draw_line(
                landmark_img,
                cur_landmarks,
                cur_facial_part["left_eye"],
                self.facial_part_color["left_eye"],
                line_width,
            )
            self.draw_line(
                landmark_img,
                cur_landmarks,
                cur_facial_part["right_eye"],
                self.facial_part_color["right_eye"],
                line_width,
            )
            self.draw_line(
                landmark_img, cur_landmarks, cur_facial_part["nose"], self.facial_part_color["nose"], line_width
            )
            self.draw_line(
                landmark_img, cur_landmarks, cur_facial_part["mouth"], self.facial_part_color["mouth"], line_width
            )
            self.draw_line(
                landmark_img,
                cur_landmarks,
                cur_facial_part["face_contour"],
                self.facial_part_color["face_contour"],
                line_width,
            )
